...
Turn in [T2863] and accept [QA2902]
...
Turn in [QT2987][QT2903] and accept [QA7703][QA7731]
...
Turn in [QT2875][QT8366][QT2873][QT8365][QT3520] and accept [QA2874][QA3527]
Hearth to [H Gadgetzan]
Turn in [QT1691][QT2781]
Accept [QA992][QA2605][QA4863][QA3362]
...
Click Lard's Luch for [QC7840] and kill the Trolls, every single one can drop the lunch, so you might not need to kill all 3.
...
Kill Water Elementals and Giants for [QC7003][QC7021] Use your Ultra shrinker on the Giants before killing them.
Turn in [QT7003][QT7021]
Hearth to [H Camp Mojache]
...
Go to [G40,22 Feralas] and do the miniaturization stuff on more giants for [QC7025] and use your muisek on them for [QC3127]
Complete the rest of [QC3128]
Abandon [Q7025] we had to accept it for the zapper only, also destroy the residue in your bags.
...
Turn in all your other Blasted Lands quests when they are done.
